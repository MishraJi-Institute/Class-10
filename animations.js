...
(() => {
  ...
  function cardTilt() {
    ...
    const cards = document.querySelectorAll('.subject-card, .guide-card, .person, .library-card');
  ...
  function pressFeedback() {
    const interactive = document.querySelectorAll('button, .primary, .secondary, .nav a, .subject-card, .library-card, .filter-bar');
  ...
  function init() {
    ...
    document.addEventListener('library:rendered', refreshDynamicMotion);
  }
